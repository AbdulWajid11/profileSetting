    ...
    <div>
      ...
      <div className="background_color_container lg:h-min ">
        ...
        <div className="container mx-auto" >
          ...
          <form className="profile_settings_form  lg:w-full">
            {/* heading */}
            <div className="heading ">
              <h3 className="text-2xl font-normal ">Personal Information</h3>
            </div>
            {/* Email_input */}
            <div className="input_div w-full lg:w-4/5">
              <label className="common_color text-xl font-medium">Email</label>
              <input
            ...
            <div className="flex flex-col lg:flex-row w-full lg:w-4/5 pt-14 pb-2">
              ...
              {/* Last_name */}
              <div className="input_div w-full lg:w-2/4 pt-2 lg:pt-0 lg:pl-8">
                <label className="common_color text-xl font-medium">
                  Last Name
                </label>
                <input
            ...
            {/* Social_Media_input */}
            <div className="Social_Media_input  w-full lg:w-4/5 py-4 lg:py-0 lg:pt-14">
              {/* first_name */}
              <div className="input_div w-full ">
                <h3 className="common_color text-xl font-medium">
            ...
            <div className=" heading_button  py-0 lg:py-6 ">
              <h3 className="text-2xl font-normal pb-2">Favourite Games</h3>
            ...
            {/* button_div */}
            <div className="button_div flex justify-center py-12">
              <div className="lg:w-1/3 ">
                <button className="text-2xl font-medium px-16 py-1">
                  SAVE
                </button>
              </div>
            </div>
